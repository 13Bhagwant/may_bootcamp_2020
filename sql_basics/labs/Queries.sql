-- Using data from this morning's lesson, write the following SQL Queries: or
...
WHERE name
ILIKE '%paper%' OR name ILIKE '%steel%';
...
ORDER BY sale_price ASC LIMIT 10 OFFSET
10;
...
WHERE remaining_quantity > 0
GROUP BY name
ORDER BY cheapest LIMIT 10 OFFSET
10;
